...
List<User> list_user = [
  User("Dummy", "123123123", DateTime.parse("1990-12-12"), "Sby", 12000, "dummy", "1234",UserType.psychiatrist),
  User("DummyPatient", "123123123", DateTime.parse("1990-12-12"), "Sby", 12000, "dp", "123",UserType.patient),
];
